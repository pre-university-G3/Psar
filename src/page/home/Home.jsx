...
const HomePage = () => {
  ...
  const brandBanners = [
    {
      ...
      brand: "Lenovo",
      title:
        "Lenovo Legion 5 Pro - A powerful gaming laptop for smooth performance and stunning visuals",
      bgColor: "bg-black",
      textColor: "text-white",
      accentColor: "bg-red-600",
      buttonText: "Shop Now",
      image:
        "https://s3.ap-southeast-1.amazonaws.com/uploads-store/uploads/all/5KgavhN0leBERGrv0Hjdf01NcpIDs2fjyzfThnD9.png", // Replace with actual image
    },
    {
      id: 2,
      brand: "ROG",
      title:
        "Unleash the future with the ultimate gaming experience designed to optimize your workflow and enhance productivity",
      bgColor: "bg-black",
      textColor: "text-white",
      accentColor: "bg-red-600",
      buttonText: "Shop Now",
      image:
        "https://dlcdnwebimgs.asus.com/files/media/B6E6970A-9728-4F44-A81E-4175939B8925/v1/img/display/strix-g-2022.png", // Replace with actual image
    },
    {
      id: 3,
      brand: "MSI",
      title:
        "Desktop PCs from MSI - the ultimate in-house desktop experience with the ultimate performance and stunning productivity",
      bgColor: "bg-black",
      textColor: "text-white",
      accentColor: "bg-red-600",
      buttonText: "Shop Now",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0GMmD6EjbI0NI1SIenr5qvLiWQDaK5gHpcA&s", // Replace with actual image
    },
  ];
  ...
  const BrandBanner = ({ banner }) => (
    <div
      className={`${banner.bgColor} ${banner.textColor} rounded-lg overflow-hidden flex`}>
      <div className="p-6 flex flex-col justify-center w-1/2">
        ...
        <button
          className={`${banner.accentColor} text-white py-1 px-4 rounded-md text-sm w-max`}>
          {banner.buttonText}
        </button>
      </div>
      <div className="w-1/2">
        ...
        <div className="bg-blue-50 rounded-lg p-8 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8">
            ...
            <p className="text-gray-700 mb-6">
              Dominate every game with ultra-fast performance, cutting-edge
              graphics, and immersive visuals. Built for gamers, creators, and
              power users.
            </p>
