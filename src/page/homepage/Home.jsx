    ...
    <div className="homepage">
      ...
      <section className="hero">
        ...
        <div className="hero-image">
          <img src="/images/hero-laptop.png" alt="Gaming Laptop" /> {/* Replace with your image path */}
        </div>
      </section>
      ...
      <section className="new-products">
        ...
        <div className="product-grid">
          {/* Sample Product Card - Repeat for each new product */}
          <div className="product-card">
            <div className="product-image">
              <img src="/images/product1.png" alt="Product 1" /> {/* Replace with your image path */}
            </div>
